...
event windows, labels each window by the next trading-day close-to-close return,
and saves both the model checkpoint and the learned causal/lag matrices.
...
- no longer coerces missing labels to class `0`.
